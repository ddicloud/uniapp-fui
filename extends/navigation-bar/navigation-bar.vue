<template>
	<view class="container">
		...
		<view class="fui-header-bg"><image src="/static/images/my/mine_bg_3x.png" class="fui-header-img"></image></view>
		<view class="header">
		...
		<fui-navigation-bar backgroundColor="#fff" :isFixed="false" :isOpacity="false" :isImmersive="false">
			<view class="fui-content-box">
				<view class="fui-avatar-box" ><image src="/static/images/news/2.jpg" class="fui-avatar"></image></view>
