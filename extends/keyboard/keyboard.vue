<template>
	<view class="container">
		...
		<view class="fui-btn-box">
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click='switchKeyboard(6)'>6位数密码</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click='switchKeyboard(4)'>4位数密码</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="lockscreen">锁屏密码</fui-button>
		</view>

		<fui-keyboard :radius="radius" :show="show" @close="closeKeyboard" @click="keyboardClick">
			<view class="fui-digital-box">
				<view class="fui-keyboard-tips">请输入密码</view>
