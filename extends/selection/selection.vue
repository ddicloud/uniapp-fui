<template>
	<view class="container">
		...
		<view class="fui-title">传入所有数据</view>
		<fui-cascade-selection height="200px" :itemList="itemList" @complete="complete"></fui-cascade-selection>

		<view class="fui-title">设置默认数据</view>
		<fui-cascade-selection height="200px" :itemList="itemList" :defaultItemList="defaultItemList" @complete="complete"></fui-cascade-selection>

		<view class="fui-title">请求返回子级数据（8级数据）</view>
		...
		<view class="fui-btn-box"><fui-button shape="circle" type="danger" @click="selectAddr">底部弹出选择+重置数据</fui-button></view>
		<fui-bottom-popup :show="show" backgroundColor="transparent" @close="close">
			<view class="fui-header">
				<view>配送至</view>
				<icon type="clear" :size="16" color="#c0c0c0" class="fui-icon-close" @tap="close"></icon>
			</view>
			<fui-cascade-selection :size="26" :textSize="24" :itemList="itemList" :reset="reset" @complete="complete3"></fui-cascade-selection>
		</fui-bottom-popup>
	</view>
</template>
