	...
	<view class="container">
		<view class="header">
			...
			<view class="sub-title">
				<text class="fui-color-primary">您选择的日期为：{{ result }}</text>
			</view>
			<view class="sub-title">
				<text class="fui-color-primary">农历：{{ lunarResult }}</text>
			</view>
		</view>
		<view class="fui-title fui-ptop20">
			显示农历（古历）
			<switch class="fui-switch" :checked="lunar" color="#5677fc" @change="switchChange"></switch>
		</view>
		<view class="fui-btn-box">
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(1)">选择单个日期</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(3)">设置日历可选范围</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(2)">选择日期区间</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(4)">自定义颜色</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(5)">自定义区间文字</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(6)">只能切换月份</fui-button>
			<fui-button margin="36rpx 0 0" type="white" shape="circle" @click="selectDate(7)">设置默认值</fui-button>
		</view>
		<!--默认直接展示-->
		<view class="fui-title">默认平铺展示</view>
		<view class="fui-calendar-box">
			<!--isChange 加上则切换年份或月份时回传数据-->
			<fui-calendar :lunar="lunar" :arrowType="2" isChange :status="status" @change="monthChange"></fui-calendar>
		</view>
		<!--底部弹出选择-->
		<fui-calendar
			:lunar="lunar"
