<template>
	<view class="container">
		...
		<view class="fui-title">无二级菜单</view>
		<fui-bottom-navigation :current="current2" :itemList="itemList2" :isFixed="false" @click="tabbar"></fui-bottom-navigation>

		<view class="fui-title">暗黑模式</view>
		<fui-bottom-navigation :isFixed="false" isDarkMode :itemList="itemList" @click="menu"></fui-bottom-navigation>

		<tab-bar :currentindex="currentTabIndex"></tab-bar>

		<view class="fui-title">有二级菜单</view>
		<fui-bottom-navigation :isFixed="false" :itemList="itemList" @click="menu"></fui-bottom-navigation>
	</view>
</template>
			...
			if (menuType === 'main') {
				...
				if (index == 0) {
					...
					if (subIndex == 0) {
						...
						this.fui.href('/pages/common/about/about');
					} else {
						const that = this;
						const url = 'https://www.fireui.cn/doc';
						// #ifdef H5
						location.href = url;
						// #endif
