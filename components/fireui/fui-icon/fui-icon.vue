<template>
	<text class="fui-icon-class fui-icon" :class="'fui-icon-' + name" :style="{ color: color || '#999', fontSize: size + unit, fontWeight: bold ? 'bold' : 'normal',margin:margin }"
...
<style scoped>
	...
	.fui-icon {
		font-family: 'fireuiFont' !important;
		font-style: normal;
