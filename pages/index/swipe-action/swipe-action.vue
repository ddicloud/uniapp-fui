<template>
	<view class="container">
		<fui-swipe-action :actions="actions"  @click="handlerButton" v-for="(item,index) in dataList"
		 :key="index" :params="item">
			<template v-slot:content>
				<view class="fui-list-item">
	...
	export default {
		...
		methods: {
			handlerButton(e) {
				let index = e.index;
				let item = e.item;
				let menuTxt = ["删除", "修改"][index];
				this.fui.toast("您点击了【" + menuTxt + "】按钮，列表id：" + item.id);
				// setTimeout(() => {
