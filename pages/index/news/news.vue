<template>
	<view class="container">
		<view class="list-view">
			<view v-for="(item,index) in newsList" :key="index" class="list-cell fui-list-item" :class="[(newsList.length-1)==index?'fui-last':'']"
			 hover-class="fui-hover" :hover-stay-time="150" @tap="detail">
		...
		<!--加载loadding-->
		<fui-loadmore v-if="loadding"></fui-loadmore>
		<fui-nomore v-if="!pullUpOn"></fui-nomore>
		<!--加载loadding-->
	</view>
</template>
