<template>
	<view class="container">
		<view class="fui-header">
			<view class="fui-title">Basic</view>
			<view class="fui-sub-title">基础组件，常用组件</view>
		</view>
		<fui-grid>
				...
				<navigator :url="item.url" hover-class='none'>
					<fui-grid-item>
						<view class="fui-grid-icon">
							<image class="fui-grid-img" :src="'https://fireui.cn/images/basic/'+item.img+'.png'" :style="{width:item.width+'rpx',height:item.height+'rpx'}" />
						</view>
