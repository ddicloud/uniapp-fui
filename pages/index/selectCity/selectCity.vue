				...
				<view class="search-bar-form">
					<view class="search-bar-box">
						...
						<view class="icon-clear" v-if="inputVal" @tap="clearInput">
							...
							<!-- #endif -->
							<!-- #ifdef H5 -->
							<fui-icon name="close-fill" :size="16" color="#bfbfbf"></fui-icon>
							<!-- #endif -->
						</view>
					</view>
			...
			<view v-if="!inputVal">
				...
				<view class="fui-list city-list">
					<block v-for="(list,index) in lists" :key="index" v-if="list.data[0]">
						<view class="fui-list-cell-divider" :id="index === 0 ? 'suoyin' : list.letter">
							{{list.letter}}
						</view>
						<view class="fui-list-cell" hover-class="fui-list-cell-hover" v-for="(item,index2) in list.data" :key="index2"
						 @tap="selectCity" :data-name="item.cityName" :hover-stay-time='150'>
							<view class="fui-list-cell-navigate" :class="[list.data.length-1==index?'last':'']">
								{{item.cityName}}
							</view>
						</view>
					</block>
