<template>
	<view class="container">
		<fui-button disabled shape="circle" margin="0 0 32rpx 0">禁用状态</fui-button>
		<fui-button disabled disabledGray shape="circle" margin="0 0 32rpx 0">禁用状态</fui-button>
		<picker :value="value" mode="multiSelector" @change="picker" @columnchange="columnPicker" :range="multiArray">
			<fui-button  shape="circle">请选择</fui-button>
		</picker>
		<view class="result">
			{{text}}
		</view>
