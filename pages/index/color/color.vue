<template>
	<view class="container">
		...
		<view class="box">
			<view class="item fui-danger">
				<view>danger</view>
				<view class="color">#ed3f14</view>
			</view>
			<view class="item fui-warning">
				<view>warning</view>
				<view class="color">#ff7900</view>
			</view>
			<view class="item fui-blue">
				<view>blue</view>
				<view class="color">#007AFF</view>
			</view>
			<view class="item fui-green">
				<view>green</view>
				<view class="color">#19be6b</view>
			</view>
			<view class="item fui-black">
				<view>black</view>
				<view class="color">#000000</view>
			</view>
			<view class="item gray fui-white">
				<view>white</view>
				<view class="color">#ffffff</view>
			</view>
			<view class="item fui-translucent">
