<template>
	<view class="container">
		...
		<map id="maps" class="fui-maps" :longitude="longitude" :latitude="latitude" :scale="16" show-location @regionchange="regionchange"
